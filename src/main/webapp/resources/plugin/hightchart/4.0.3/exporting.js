/*
 ...
 http://192.168.100.15:6888/aicap/svg/svgConverter.do
...
(function (f) {
    ...
    p(s.lang, {
        printChart: "打印图表",
        downloadPNG: "PNG 格式下载",
        downloadJPEG: "JPEG 格式下载",
        downloadTIFF: "TIFF 格式下载",
        downloadPDF: "PDF 格式下载",
        downloadSVG: "SVG 格式下载",
    ...
    s.exporting = {
        type: "image/png", url: "http://192.168.100.15:6888/aicap/svg/svgConverter.do", buttons: {
            contextButton: {
                ...
                menuItems: [{
                    ...
                    textKey: "downloadTIFF", onclick: function () {
